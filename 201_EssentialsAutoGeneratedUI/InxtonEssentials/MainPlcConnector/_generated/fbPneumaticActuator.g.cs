...
#pragma warning disable SA1402, CS1591, CS0108, CS0067
	...
	public partial class fbPneumaticActuator : Vortex.Connector.IVortexObject, IfbPneumaticActuator, IShadowfbPneumaticActuator, Vortex.Connector.IVortexOnlineObject, Vortex.Connector.IVortexShadowObject
	{
		...
		Vortex.Connector.ValueTypes.OnlinerInt __simulatedPosition;
		public Vortex.Connector.ValueTypes.OnlinerInt _simulatedPosition
		{
			get
			{
				return __simulatedPosition;
			}
		}

		Vortex.Connector.ValueTypes.Online.IOnlineInt IfbPneumaticActuator._simulatedPosition
		{
			get
			{
		...
		Vortex.Connector.ValueTypes.Shadows.IShadowInt IShadowfbPneumaticActuator._simulatedPosition
		{
			get
			{
				return _simulatedPosition;
		...
		public void LazyOnlineToShadow()
		{
			...
			_simulatedPosition.Shadow = _simulatedPosition.LastValue;
		}
		...
		public void LazyShadowToOnline()
		{
			...
			_simulatedPosition.Cyclic = _simulatedPosition.Shadow;
		}
	...
	public partial interface IfbPneumaticActuator : Vortex.Connector.IVortexOnlineObject
	{
		...
		Vortex.Connector.ValueTypes.Online.IOnlineInt _simulatedPosition
		{
			get;
		}
	...
	public partial interface IShadowfbPneumaticActuator : Vortex.Connector.IVortexShadowObject
	{
		...
		Vortex.Connector.ValueTypes.Shadows.IShadowInt _simulatedPosition
		{
			get;
		}
	...
	public partial class PlainfbPneumaticActuator : System.ComponentModel.INotifyPropertyChanged, Vortex.Connector.IPlain
	{
		...
		System.Int16 __simulatedPosition;
		public System.Int16 _simulatedPosition
		{
			get
			{
				return __simulatedPosition;
			...
			set
			{
				if (__simulatedPosition != value)
				{
					__simulatedPosition = value;
					PropertyChanged?.Invoke(this, new System.ComponentModel.PropertyChangedEventArgs(nameof(_simulatedPosition)));
				}
			}
		}
		...
		public void CopyPlainToCyclic(MainPlc.fbPneumaticActuator target)
		{
			...
			target._simulatedPosition.Cyclic = _simulatedPosition;
		}
		...
		public void CopyPlainToShadow(MainPlc.fbPneumaticActuator target)
		{
			...
			target._simulatedPosition.Shadow = _simulatedPosition;
		}
		...
		public void CopyCyclicToPlain(MainPlc.fbPneumaticActuator source)
		{
			...
			_simulatedPosition = source._simulatedPosition.LastValue;
		}
		...
		public void CopyShadowToPlain(MainPlc.fbPneumaticActuator source)
		{
			...
			_simulatedPosition = source._simulatedPosition.Shadow;
		}
